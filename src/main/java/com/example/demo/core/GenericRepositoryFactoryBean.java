...
public class GenericRepositoryFactoryBean<R extends JpaRepository<T, ID>, T, ID> extends JpaRepositoryFactoryBean<R, T, ID> {
    ...
    protected RepositoryFactorySupport createRepositoryFactory(EntityManager entityManager) {
        GenenricRepositoryFactory<Object, Object> factory = new GenenricRepositoryFactory<>(entityManager);
        factory.addRepositoryProxyPostProcessor(new CustomRepositoryProxyPostProcessor());
        return factory;
    }

    private static class GenenricRepositoryFactory<T, ID>
            extends JpaRepositoryFactory {
        private final EntityManager entityManager;

        public GenenricRepositoryFactory(EntityManager entityManager) {
            super(entityManager);
